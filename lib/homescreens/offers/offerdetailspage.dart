...
class OfferDetailsPage extends StatefulWidget {
  final String id;
  const OfferDetailsPage({super.key, required this.id});
...
class _OfferDetailsPageState extends State<OfferDetailsPage> {
  ...
  void initState() {
    ...
    super.initState();
    bussinesscontroller.getBussinessdetails(id: widget.id);
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        builder: (controller) {
          return controller.detailsshow == false
              ? Center(
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(
                                              // "4.8 Rating",
                                              "${controller.bussinessdetails.businessAdvertiseDetails?.first.distance} rating",
                                              style: TextStyle(
                                                  color: Colors.grey,
                                                  fontSize: 16,
                                                  fontWeight: FontWeight.w500),
                                      ...
                                      Column(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              "Offer expires on ${ controller.bussinessdetails.businessAdvertise?.validityTo}",
                                              style: textstyle(
