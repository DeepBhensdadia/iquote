...
class LoanDetailsPage extends StatefulWidget {
  final String id;
  const LoanDetailsPage({super.key, required this.id});
...
class _LoanDetailsPageState extends State<LoanDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(body: GetBuilder<BussinessCategoryController>(
        builder: (controller) {
                                      ...
                                      Column(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              "Loan ID - ${controller.bussinessdetails.businessAdvertiseDetails?.first.advertiseIds}",
                                              style: textstyle(
