...
class CreateCatelogs extends StatefulWidget {
  const CreateCatelogs({super.key});

  @override
  State<CreateCatelogs> createState() => _CreateCatelogsState();
}

class _CreateCatelogsState extends State<CreateCatelogs> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: const Text("Create Catelogue"), actions: [
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CreateCustomerUi(
                      Controlleer: catelogControler.productname,
                      name: 'Add Product',
                    ...
                    CreateCustomerUi(
                      Controlleer: catelogControler.brand,
                    ...
                    CreateCustomerUi(
                      Controlleer: catelogControler.value,
                    ...
                    CreateCustomerUi(
                      Controlleer: catelogControler.discription,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            catelogControler.createCatelogue();
                          },
                          child: Container(
                            width: 100,
                            height: 35,
